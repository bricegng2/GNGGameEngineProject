...
{
    { vec2(-0.5f, 0.5f), 255, 255, 255, 255 }, // Top-left
    { vec2(-0.5f,-0.5f), 255, 255, 255, 255 }, // Bottom-left
    { vec2( 0.5f,-0.5f), 255, 255, 255, 255 }, // Bottom-right

    { vec2(-0.5f, 0.5f), 255, 255, 255, 255 }, // Top-left
    { vec2( 0.5f,-0.5f), 255, 255, 255, 255 }, // Bottom-right
    { vec2( 0.5f, 0.5f), 255, 255, 255, 255 }, // Top-right
};
