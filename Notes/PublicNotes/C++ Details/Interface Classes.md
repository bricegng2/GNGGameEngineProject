...
- An abstract class called GameCore. i.e. the interface
	- As a start, we want methods for Update and Draw
	- We'll add more virtual methods as time goes to allow the Framework to make new calls into the Game. For example, for input events

In the Game project:
- A class called Game that inherits from GameCore
	- This will override the Update and Draw and do the actual updating and drawing of a list of GameObjects held in the Game class
