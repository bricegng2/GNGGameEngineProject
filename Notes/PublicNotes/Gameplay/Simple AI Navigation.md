...
Beyond finding a path, we need our AI to work its way from its current location to the next point along its path. In this logic, the object being moved is often referred to as an Agent.
