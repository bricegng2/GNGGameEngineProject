...
#### Preprocessor Defines in Visual Studio

Preprocessor defines can be created in C++ code:
...
In this example, Windows.h can no make decisions to skip over certain includes or declarations when it's being preprocessed, like so:
...
Sometimes you want to define preprocessor values outside to code to influence it without changing the code itself. This can be done per project in the project settings. See [C/C++ / Preprocessor](../C++%20Visual%20Studio/Solution%20and%20Project%20Settings.md#C/C++%20/%20Preprocessor).
