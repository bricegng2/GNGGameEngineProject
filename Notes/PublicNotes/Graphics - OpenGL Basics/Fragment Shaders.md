...
You **can't** printf or cout variable values to the output window
...
```c++
//glsl
gl_FragColor = vec4( u_Time/10.0, 0, 0, 1 );
```

will show your object being gradually more red over 10 seconds, otherwise u_Time is incorrect.
