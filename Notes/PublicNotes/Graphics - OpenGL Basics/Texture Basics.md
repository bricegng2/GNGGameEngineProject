...
See Also: [Extra Attributes](Extra%20Attributes.md)
...
void main()
{
	...
	// It's meant to show that the UV are correctly being passed in
...
NOTE: The uniform for a "sampler2D" type is an int, so set its value with glUniform1i
